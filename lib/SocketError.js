...
var SocketError = module.exports = createError({
    ...
    preprocess: function (err) {
        if (!(err instanceof SocketError) && err !== 'NotSocketError') {
            ...
            } else if (err && err.code && Object.prototype.hasOwnProperty.call(socketCodesMap, err.code)) {
...
SocketError.supports = function (errorOrErrorCode) {
    if (typeof errorOrErrorCode === 'string') {
        return Object.prototype.hasOwnProperty.call(socketCodesMap, errorOrErrorCode);
    } else if (errorOrErrorCode && errorOrErrorCode.code) {
        return Object.prototype.hasOwnProperty.call(socketCodesMap, errorOrErrorCode.code);
    } else {
        return false;
    }
};
